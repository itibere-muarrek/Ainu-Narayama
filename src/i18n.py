...
T: dict[str, dict[str, str]] = {
    ...
    "narayama_intro": {
        "pt": "Acompanhe, de forma simples, a capacidade de renovação geracional de 7 países ao final de um ciclo de 25 anos — com base na tese de doutorado \"Do Dilema de Narayama ao Oicoceno Civilizacional\" (V12). Para análises detalhadas, simulações e calibração, veja [ainu.systems](https://ainu.systems).",
        "en": "Track, in simple terms, the generational renewal capacity of 7 countries at the end of a 25-year cycle — based on the doctoral thesis \"From Narayama's Dilemma to the Civilizational Oikocene\" (V12). For detailed analysis, simulations and calibration, see [ainu.systems](https://ainu.systems).",
        "es": "Siga, de forma simple, la capacidad de renovación generacional de 7 países al final de un ciclo de 25 años — según la tesis doctoral \"Del Dilema de Narayama al Oicoceno Civilizacional\" (V12). Para análisis detallados, simulaciones y calibración, vea [ainu.systems](https://ainu.systems).",
        "ja": "博士論文『ナラヤマのジレンマから文明的オイコセーンへ』（V12）に基づき、25年周期の終わりにおける7か国の世代更新能力をシンプルに追跡します。詳細な分析やシミュレーション、キャリブレーションについては[ainu.systems](https://ainu.systems)をご覧ください。",
        "ko": "박사 학위논문 『나라야마의 딜레마에서 문명적 오이코세까지』(V12)를 바탕으로, 25년 주기가 끝나는 시점의 7개국 세대 재생산 능력을 간단히 살펴봅니다. 자세한 분석, 시뮬레이션, 보정은 [ainu.systems](https://ainu.systems)에서 확인하세요.",
        "it": "Segui, in modo semplice, la capacità di rinnovamento generazionale di 7 paesi al termine di un ciclo di 25 anni — sulla base della tesi di dottorato \"Dal Dilemma di Narayama all'Oicocene Civilizzazionale\" (V12). Per analisi dettagliate, simulazioni e calibrazione, vedi [ainu.systems](https://ainu.systems).",
        "fi": "Seuraa yksinkertaisesti 7 maan sukupolvien uusiutumiskykyä 25 vuoden syklin lopussa — perustuen väitöskirjaan \"Narayaman dilemmasta sivilisaation Oikoseeniin\" (V12). Yksityiskohtaista analyysia, simulaatioita ja kalibrointia varten katso [ainu.systems](https://ainu.systems).",
        "fr": "Suivez, de façon simple, la capacité de renouvellement générationnel de 7 pays à la fin d'un cycle de 25 ans — d'après la thèse de doctorat \"Du Dilemme de Narayama à l'Oïcocène Civilisationnel\" (V12). Pour des analyses détaillées, des simulations et un calibrage, voir [ainu.systems](https://ainu.systems).",
        "zh": "基于博士论文《从楢山难题到文明世的宜居纪》(V12)，简明呈现7个国家在25年周期结束时的世代更新能力。详细分析、模拟与校准请见[ainu.systems](https://ainu.systems)。",
    },
    "narayama_info": {
    ...
    "narayama_caption_grade": {
        ...
        "en": "Grid of the 7 featured countries by Narayama Index zone (Population Excess/PEEC → Collapse/PEC), countries ordered by current population within each zone. The institutional beacon shows as a gap (`n/a`) — same explanation as the box above.",
        ...
        "ja": "ナラヤマ指数のゾーン別（人口過剰/PEEC → 崩壊/PEC）に注目7か国を並べたグリッドで、各ゾーン内は現在の人口順です。制度的ビーコンは欠落（N/A）として表示されます — 上記ボックスと同じ説明です。",
        "ko": "나라야마 지수 구역별(과잉 인구/PEEC → 붕괴/PEC)로 정리한 주요 7개국 그리드이며, 각 구역 내에서는 현재 인구순으로 정렬됩니다. 제도적 신호등은 공백(N/A)으로 표시됩니다 — 위 상자와 동일한 설명입니다.",
        ...
        "fr": "Grille des 7 pays en vedette par zone de l'indice de Narayama (Excès démographique/PEEC → Effondrement/PEC), pays classés par population actuelle au sein de chaque zone. Le repère institutionnel apparaît comme une lacune (`n/d`) — même explication que l'encadré ci-dessus.",
        "zh": "按楢山指数区域（人口过剩/PEEC → 崩溃/PEC）排列的7个重点国家网格，各区域内按当前人口排序。制度信号灯显示为空缺（N/A）——说明同上方信息框。",
    },
