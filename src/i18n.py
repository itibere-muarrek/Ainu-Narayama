...
T: dict[str, dict[str, str]] = {
    ...
    "narayama_intro": {
        "pt": "Acompanhe, de forma simples, a capacidade de renovação geracional de 7 países ao final de um ciclo de 25 anos — com base na tese de doutorado \"Do Dilema de Narayama ao Oicoceno Civilizacional\" (V1_11). Para análises detalhadas, simulações e calibração, veja [ainu.systems](https://ainu.systems).",
        "en": "Track, in simple terms, the generational renewal capacity of 7 countries at the end of a 25-year cycle — based on the doctoral thesis \"From Narayama's Dilemma to the Civilizational Oikocene\" (V1_11). For detailed analysis, simulations and calibration, see [ainu.systems](https://ainu.systems).",
        "es": "Siga, de forma simple, la capacidad de renovación generacional de 7 países al final de un ciclo de 25 años — según la tesis doctoral \"Del Dilema de Narayama al Oicoceno Civilizacional\" (V1_11). Para análisis detallados, simulaciones y calibración, vea [ainu.systems](https://ainu.systems).",
        "ja": "博士論文『ナラヤマのジレンマから文明的オイコセーンへ』（V1_11）に基づき、25年周期の終わりにおける7か国の世代更新能力をシンプルに追跡します。詳細な分析やシミュレーション、キャリブレーションについては[ainu.systems](https://ainu.systems)をご覧ください。",
        "ko": "박사 학위논문 『나라야마의 딜레마에서 문명적 오이코세까지』(V1_11)를 바탕으로, 25년 주기가 끝나는 시점의 7개국 세대 재생산 능력을 간단히 살펴봅니다. 자세한 분석, 시뮬레이션, 보정은 [ainu.systems](https://ainu.systems)에서 확인하세요.",
        "it": "Segui, in modo semplice, la capacità di rinnovamento generazionale di 7 paesi al termine di un ciclo di 25 anni — sulla base della tesi di dottorato \"Dal Dilemma di Narayama all'Oicocene Civilizzazionale\" (V1_11). Per analisi dettagliate, simulazioni e calibrazione, vedi [ainu.systems](https://ainu.systems).",
        "fi": "Seuraa yksinkertaisesti 7 maan sukupolvien uusiutumiskykyä 25 vuoden syklin lopussa — perustuen väitöskirjaan \"Narayaman dilemmasta sivilisaation Oikoseeniin\" (V1_11). Yksityiskohtaista analyysia, simulaatioita ja kalibrointia varten katso [ainu.systems](https://ainu.systems).",
        "fr": "Suivez, de façon simple, la capacité de renouvellement générationnel de 7 pays à la fin d'un cycle de 25 ans — d'après la thèse de doctorat \"Du Dilemme de Narayama à l'Oïcocène Civilisationnel\" (V1_11). Pour des analyses détaillées, des simulations et un calibrage, voir [ainu.systems](https://ainu.systems).",
        "zh": "基于博士论文《从楢山难题到文明世的宜居纪》(V1_11)，简明呈现7个国家在25年周期结束时的世代更新能力。详细分析、模拟与校准请见[ainu.systems](https://ainu.systems)。",
    },
    "narayama_info": {
        ...
        "en": "**How to read N\\*:** it's not a \"higher is better\" score — it's a balance across 5 zones. A very low N\\* indicates **Narayama Collapse (PEC)** (< 0.71): too few births to replace the legacy generation. Just above that, **Accelerated Tension** (0.71-0.90) already signals an early warning of collapse. The ideal sits in the middle of the scale, a range called **Sustainable Equilibrium (PEA)** (0.90-1.40). Just above that, **Population Tension** (1.40-2.00) already signals an early warning of saturation. A very high N\\* indicates **Population Excess Saturation (PEEC)** (≥ 2.00): population growth accelerating beyond institutional absorption capacity. The institutional beacon (+/n/-) doesn't appear here yet: it depends on National Transfer Accounts (NTA) data this project doesn't have yet — see [ainu.systems](https://ainu.systems) for the full methodology.",
        ...
        "zh": "**如何解读N\\*：** 这不是“越高越好”的分数，而是跨越5个区域的一种平衡。N\\*过低表示 **楢山崩溃(PEC)** (低于0.71)：出生人数过少，无法替代上一代人。紧邻其上的 **加速紧张** (0.71-0.90)已经是崩溃的早期预警信号。理想值位于量表中段，称为 **可持续平衡(PEA)** (0.90-1.40)区间。紧邻其上的 **人口紧张** (1.40-2.00)已经是饱和的早期预警信号。N\\*过高表示 **人口过剩饱和(PEEC)** (2.00及以上)：人口增长速度超过了制度吸纳能力。制度信号灯（+/n/-）此处尚未显示：它依赖于本项目尚未获取的国民转移账户（NTA）数据 — 完整方法论请见[ainu.systems](https://ainu.systems)。",
    },
    ...
    "ainu_intro": {
        "pt": "Cálculos detalhados do Índice de Narayama Sistêmico (N\\*) para os 28 países da amostra, com base na tese de doutorado \"Do Dilema de Narayama ao Oicoceno Civilizacional\" (V1_11). Para a visão pública e simplificada, veja [narayama.live](https://narayama.live).",
        "en": "Detailed calculations of the Systemic Narayama Index (N\\*) for the 28 countries in the sample, based on the doctoral thesis \"From Narayama's Dilemma to the Civilizational Oikocene\" (V1_11). For the public, simplified view, see [narayama.live](https://narayama.live).",
        "es": "Cálculos detallados del Índice de Narayama Sistémico (N\\*) para los 28 países de la muestra, según la tesis doctoral \"Del Dilema de Narayama al Oicoceno Civilizacional\" (V1_11). Para la vista pública y simplificada, vea [narayama.live](https://narayama.live).",
        "ja": "博士論文『ナラヤマのジレンマから文明的オイコセーンへ』（V1_11）に基づく、サンプル28か国のシステミック・ナラヤマ指数（N\\*）の詳細な計算です。公開・簡易版は[narayama.live](https://narayama.live)をご覧ください。",
        "ko": "박사 학위논문 『나라야마의 딜레마에서 문명적 오이코세까지』(V1_11)를 바탕으로 한 표본 28개국의 체계적 나라야마 지수(N\\*) 상세 계산입니다. 공개용 간략 버전은 [narayama.live](https://narayama.live)를 참고하세요.",
        "it": "Calcoli dettagliati dell'Indice di Narayama Sistemico (N\\*) per i 28 paesi del campione, sulla base della tesi di dottorato \"Dal Dilemma di Narayama all'Oicocene Civilizzazionale\" (V1_11). Per la vista pubblica e semplificata, vedi [narayama.live](https://narayama.live).",
        "fi": "Yksityiskohtaiset laskelmat systeemisestä Narayama-indeksistä (N\\*) otoksen 28 maalle, perustuen väitöskirjaan \"Narayaman dilemmasta sivilisaation Oikoseeniin\" (V1_11). Julkista, yksinkertaistettua näkymää varten katso [narayama.live](https://narayama.live).",
        "fr": "Calculs détaillés de l'indice de Narayama systémique (N\\*) pour les 28 pays de l'échantillon, d'après la thèse de doctorat \"Du Dilemme de Narayama à l'Oïcocène Civilisationnel\" (V1_11). Pour la vue publique simplifiée, voir [narayama.live](https://narayama.live).",
        "zh": "基于博士论文《从楢山难题到文明世的宜居纪》(V1_11)，对样本中28个国家的系统性楢山指数（N\\*）进行详细计算。公开简化版请见[narayama.live](https://narayama.live)。",
    },
    ...
    "glossario_intro": {
        "pt": "Todos os termos e siglas da tese, em ordem de aparição — inclui conceitos de fases futuras ainda não implementadas neste projeto (Anexo 14 da tese V1_11, com a correção dos limiares de PEC/PEA/PEEC pra convenção adotada de 5 zonas, ver docs/definitions.md).",
        "en": "All terms and acronyms from the thesis, in order of appearance — includes concepts from future phases not yet implemented in this project (thesis V1_11, Annex 14, with PEC/PEA/PEEC thresholds corrected to the adopted 5-zone convention — see docs/definitions.md).",
        "es": "Todos los términos y siglas de la tesis, en orden de aparición — incluye conceptos de fases futuras aún no implementadas en este proyecto (Anexo 14 de la tesis V1_11, con la corrección de los umbrales de PEC/PEA/PEEC a la convención adoptada de 5 zonas, ver docs/definitions.md).",
        "ja": "論文のすべての用語と略語を、登場順に記載 — 本プロジェクトではまだ実装されていない将来フェーズの概念も含む（論文V1_11、附属書14、PEC/PEA/PEECの閾値は採用された5ゾーン規約に修正済み — docs/definitions.md参照）。",
        "ko": "논문의 모든 용어와 약어를 등장 순서대로 수록 — 이 프로젝트에서 아직 구현되지 않은 향후 단계의 개념도 포함(논문 V1_11, 부록 14, PEC/PEA/PEEC 임계값은 채택된 5구역 규약으로 수정됨 — docs/definitions.md 참고).",
        "it": "Tutti i termini e le sigle della tesi, in ordine di apparizione — include concetti di fasi future non ancora implementate in questo progetto (Allegato 14 della tesi V1_11, con la correzione delle soglie PEC/PEA/PEEC alla convenzione adottata a 5 zone, vedi docs/definitions.md).",
        "fi": "Kaikki väitöskirjan termit ja lyhenteet esiintymisjärjestyksessä — sisältää käsitteitä tulevista vaiheista, joita ei ole vielä toteutettu tässä projektissa (väitöskirja V1_11, liite 14, PEC/PEA/PEEC-kynnysarvot korjattu vastaamaan hyväksyttyä 5-vyöhykkeen käytäntöä — katso docs/definitions.md).",
        "fr": "Tous les termes et acronymes de la thèse, dans l'ordre d'apparition — inclut des concepts de phases futures pas encore implémentées dans ce projet (Annexe 14 de la thèse V1_11, avec les seuils PEC/PEA/PEEC corrigés selon la convention adoptée à 5 zones, voir docs/definitions.md).",
        "zh": "论文中所有术语和缩写，按出现顺序排列——包括本项目尚未实现的未来阶段概念（论文V1_11附录14，其中PEC/PEA/PEEC阈值已按采用的5区域惯例更正——见docs/definitions.md）。",
    },
    "footer_ainu": {
...
# -----------------------------------------------------------------------
# Glossário (Anexo 14 da tese V1_11) — termos e siglas de todo o projeto,
