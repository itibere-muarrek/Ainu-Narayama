...
T: dict[str, dict[str, str]] = {
    ...
    "narayama_intro": {
        "pt": "Acompanhe, de forma simples, a capacidade de renovação geracional de 8 países ao final de um ciclo de 25 anos — com base na tese de doutorado \"Do Dilema de Narayama ao Oicoceno Civilizacional\" (V12). Para análises detalhadas, simulações e calibração, veja [ainu.systems](https://ainu.systems).",
        "en": "Track, in simple terms, the generational renewal capacity of 8 countries at the end of a 25-year cycle — based on the doctoral thesis \"From Narayama's Dilemma to the Civilizational Oikocene\" (V12). For detailed analysis, simulations and calibration, see [ainu.systems](https://ainu.systems).",
        "es": "Siga, de forma simple, la capacidad de renovación generacional de 8 países al final de un ciclo de 25 años — según la tesis doctoral \"Del Dilema de Narayama al Oicoceno Civilizacional\" (V12). Para análisis detallados, simulaciones y calibración, vea [ainu.systems](https://ainu.systems).",
        "ja": "博士論文『ナラヤマのジレンマから文明的オイコセーンへ』（V12）に基づき、25年周期の終わりにおける8か国の世代更新能力をシンプルに追跡します。詳細な分析やシミュレーション、キャリブレーションについては[ainu.systems](https://ainu.systems)をご覧ください。",
        "ko": "박사 학위논문 『나라야마의 딜레마에서 문명적 오이코세까지』(V12)를 바탕으로, 25년 주기가 끝나는 시점의 8개국 세대 재생산 능력을 간단히 살펴봅니다. 자세한 분석, 시뮬레이션, 보정은 [ainu.systems](https://ainu.systems)에서 확인하세요.",
        "it": "Segui, in modo semplice, la capacità di rinnovamento generazionale di 8 paesi al termine di un ciclo di 25 anni — sulla base della tesi di dottorato \"Dal Dilemma di Narayama all'Oicocene Civilizzazionale\" (V12). Per analisi dettagliate, simulazioni e calibrazione, vedi [ainu.systems](https://ainu.systems).",
        "fi": "Seuraa yksinkertaisesti 8 maan sukupolvien uusiutumiskykyä 25 vuoden syklin lopussa — perustuen väitöskirjaan \"Narayaman dilemmasta sivilisaation Oikoseeniin\" (V12). Yksityiskohtaista analyysia, simulaatioita ja kalibrointia varten katso [ainu.systems](https://ainu.systems).",
        "fr": "Suivez, de façon simple, la capacité de renouvellement générationnel de 8 pays à la fin d'un cycle de 25 ans — d'après la thèse de doctorat \"Du Dilemme de Narayama à l'Oïcocène Civilisationnel\" (V12). Pour des analyses détaillées, des simulations et un calibrage, voir [ainu.systems](https://ainu.systems).",
        "zh": "基于博士论文《从楢山难题到文明世的宜居纪》(V12)，简明呈现8个国家在25年周期结束时的世代更新能力。详细分析、模拟与校准请见[ainu.systems](https://ainu.systems)。",
    },
    "narayama_info": {
    ...
    "farol_provisorio_caption": {
        ...
        "fi": "Myös narayama.liven 8 esitellylle maalle on olemassa väliaikainen valoarvo, joka on peritty putken päivitystä edeltävästä väestötieteellis-TFR-mallista (väitöskirjan taulukko 3.1.1) — mutta päätös oli olla julkaisematta sitä: se ei perustu todelliseen National Transfer Accounts (NTA) -lähteeseen. Siksi valo näkyy korteissa aina merkinnällä N/A, myös näiden 8 maan kohdalla.",
    ...
    "ainu_intro": {
        "pt": "Cálculos detalhados do Índice de Narayama Sistêmico (N\\*) para os 28 países da amostra, com base na tese de doutorado \"Do Dilema de Narayama ao Oicoceno Civilizacional\" (V12). Para a visão pública e simplificada, veja [narayama.live](https://narayama.live).",
        "en": "Detailed calculations of the Systemic Narayama Index (N\\*) for the 28 countries in the sample, based on the doctoral thesis \"From Narayama's Dilemma to the Civilizational Oikocene\" (V12). For the public, simplified view, see [narayama.live](https://narayama.live).",
        "es": "Cálculos detallados del Índice de Narayama Sistémico (N\\*) para los 28 países de la muestra, según la tesis doctoral \"Del Dilema de Narayama al Oicoceno Civilizacional\" (V12). Para la vista pública y simplificada, vea [narayama.live](https://narayama.live).",
        "ja": "博士論文『ナラヤマのジレンマから文明的オイコセーンへ』（V12）に基づく、サンプル28か国のシステミック・ナラヤマ指数（N\\*）の詳細な計算です。公開・簡易版は[narayama.live](https://narayama.live)をご覧ください。",
        "ko": "박사 학위논문 『나라야마의 딜레마에서 문명적 오이코세까지』(V12)를 바탕으로 한 표본 28개국의 체계적 나라야마 지수(N\\*) 상세 계산입니다. 공개용 간략 버전은 [narayama.live](https://narayama.live)를 참고하세요.",
        "it": "Calcoli dettagliati dell'Indice di Narayama Sistemico (N\\*) per i 28 paesi del campione, sulla base della tesi di dottorato \"Dal Dilemma di Narayama all'Oicocene Civilizzazionale\" (V12). Per la vista pubblica e semplificata, vedi [narayama.live](https://narayama.live).",
        "fi": "Yksityiskohtaiset laskelmat systeemisestä Narayama-indeksistä (N\\*) otoksen 28 maalle, perustuen väitöskirjaan \"Narayaman dilemmasta sivilisaation Oikoseeniin\" (V12). Julkista, yksinkertaistettua näkymää varten katso [narayama.live](https://narayama.live).",
        "fr": "Calculs détaillés de l'indice de Narayama systémique (N\\*) pour les 28 pays de l'échantillon, d'après la thèse de doctorat \"Du Dilemme de Narayama à l'Oïcocène Civilisationnel\" (V12). Pour la vue publique simplifiée, voir [narayama.live](https://narayama.live).",
        "zh": "基于博士论文《从楢山难题到文明世的宜居纪》(V12)，对样本中28个国家的系统性楢山指数（N\\*）进行详细计算。公开简化版请见[narayama.live](https://narayama.live)。",
    },
    ...
    "glossario_intro": {
        ...
        "fi": "Kaikki väitöskirjan termit ja lyhenteet esiintymisjärjestyksessä — sisältää käsitteitä tulevista vaiheista, joita ei ole vielä toteutettu tässä projektissa (väitöskirja V12, liite 14, PEC/PEA/PEEC-kynnysarvot korjattu vastaamaan hyväksyttyä 5-vyöhykkeen käytäntöä — katso docs/definitions.md).",
