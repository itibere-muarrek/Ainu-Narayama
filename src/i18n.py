...
ZONAS: dict[str, dict[str, str]] = {
    ...
    "Ponto de Equilíbrio Autossustentável (PEA)": {
        "pt": "Ponto de Equilíbrio Autossustentável (PEA)", "en": "Self-Sustaining Equilibrium Point (PEA)",
        "es": "Punto de Equilibrio Autosostenible (PEA)", "ja": "自己持続的均衡点 (PEA)",
        "ko": "자립 균형점 (PEA)", "it": "Punto di Equilibrio Autosostenibile (PEA)",
        "fi": "Itseään ylläpitävä tasapainopiste (PEA)", "fr": "Point d'équilibre autosuffisant (PEA)",
        "zh": "自我可持续均衡点 (PEA)",
    },
    "Tensão Populacional": {
    ...
    "Saturação por Excesso de Contingente (PEEC)": {
        "pt": "Saturação por Excesso de Contingente (PEEC)", "en": "Population Excess Saturation (PEEC)",
        "es": "Saturación por Exceso de Contingente (PEEC)", "ja": "人口過剰飽和 (PEEC)",
        "ko": "과잉 인구 포화 (PEEC)", "it": "Saturazione per Eccesso Demografico (PEEC)",
        "fi": "Väestöylijäämän kyllästymä (PEEC)", "fr": "Saturation par excès démographique (PEEC)",
        "zh": "人口过剩饱和 (PEEC)",
    },
}
...
T: dict[str, dict[str, str]] = {
    ...
    "n_star_header_destaque": {
        "pt": "N\\* — 8 Países Destaque (2024)", "en": "N\\* — 8 Featured Countries (2024)",
        "es": "N\\* — 8 Países Destacados (2024)", "ja": "N\\* — 注目8カ国（2024年）",
        "ko": "N\\* — 주요 8개국 (2024)", "it": "N\\* — 8 Paesi in Evidenza (2024)",
        "fi": "N\\* — 8 esiteltyä maata (2024)", "fr": "N\\* — 8 pays en vedette (2024)",
        "zh": "N\\* — 8个重点国家（2024年）",
    },
    "bar_chart_title": {
    ...
    "narayama_intro": {
        "pt": "Acompanhe, de forma simples, a capacidade de renovação geracional de 8 países ao final de um ciclo de 25 anos — com base em pesquisa independente \"Do Dilema de Narayama ao Oicoceno Civilizacional\" (V12). Para análises detalhadas, simulações e calibração, veja [ainu.systems](https://ainu.systems).",
        "en": "Track, in simple terms, the generational renewal capacity of 8 countries at the end of a 25-year cycle — based on independent research \"From Narayama's Dilemma to the Civilizational Oikocene\" (V12). For detailed analysis, simulations and calibration, see [ainu.systems](https://ainu.systems).",
        "es": "Siga, de forma simple, la capacidad de renovación generacional de 8 países al final de un ciclo de 25 años — según la investigación independiente \"Del Dilema de Narayama al Oicoceno Civilizacional\" (V12). Para análisis detallados, simulaciones y calibración, vea [ainu.systems](https://ainu.systems).",
        "ja": "独立研究『ナラヤマのジレンマから文明的オイコセーンへ』（V12）に基づき、25年周期の終わりにおける8か国の世代更新能力をシンプルに追跡します。詳細な分析やシミュレーション、キャリブレーションについては[ainu.systems](https://ainu.systems)をご覧ください。",
        "ko": "독립 연구 『나라야마의 딜레마에서 문명적 오이코세까지』(V12)를 바탕으로, 25년 주기가 끝나는 시점의 8개국 세대 재생산 능력을 간단히 살펴봅니다. 자세한 분석, 시뮬레이션, 보정은 [ainu.systems](https://ainu.systems)에서 확인하세요.",
        "it": "Segui, in modo semplice, la capacità di rinnovamento generazionale di 8 paesi al termine di un ciclo di 25 anni — sulla base di una ricerca indipendente \"Dal Dilemma di Narayama all'Oicocene Civilizzazionale\" (V12). Per analisi dettagliate, simulazioni e calibrazione, vedi [ainu.systems](https://ainu.systems).",
        "fi": "Seuraa yksinkertaisesti 8 maan sukupolvien uusiutumiskykyä 25 vuoden syklin lopussa — perustuen itsenäiseen tutkimukseen \"Narayaman dilemmasta sivilisaation Oikoseeniin\" (V12). Yksityiskohtaista analyysia, simulaatioita ja kalibrointia varten katso [ainu.systems](https://ainu.systems).",
        "fr": "Suivez, de façon simple, la capacité de renouvellement générationnel de 8 pays à la fin d'un cycle de 25 ans — d'après une recherche indépendante \"Du Dilemme de Narayama à l'Oïcocène Civilisationnel\" (V12). Pour des analyses détaillées, des simulations et un calibrage, voir [ainu.systems](https://ainu.systems).",
        "zh": "基于独立研究《从楢山难题到文明世的宜居纪》(V12)，简明呈现8个国家在25年周期结束时的世代更新能力。详细分析、模拟与校准请见[ainu.systems](https://ainu.systems)。",
    },
    "narayama_info": {
        "pt": "**Como ler o N\\*:** não é uma nota de \"quanto maior, melhor\" — é um equilíbrio ao longo de 5 zonas. N\\* muito baixo indica **Colapso de Narayama (PEC)** (< 0,71): poucos nascimentos não repõem a geração legatária. Logo acima, **Tensão Acelerada** (0,71–0,90) já sinaliza risco antecipado de colapso. O ideal fica no meio da escala, faixa chamada de **Ponto de Equilíbrio Autossustentável (PEA)** (0,90–1,40). Logo acima disso, **Tensão Populacional** (1,40–2,00) já sinaliza risco antecipado de saturação. N\\* muito alto indica **Saturação por Excesso de Contingente (PEEC)** (≥ 2,00): crescimento populacional acelerado além da capacidade de absorção institucional. O farol institucional (+/n/-) ainda não aparece aqui: depende de dados de Contas de Transferências Nacionais (NTA) que este projeto ainda não tem — ver [ainu.systems](https://ainu.systems) para o detalhamento completo da metodologia.",
        "en": "**How to read N\\*:** it's not a \"higher is better\" score — it's a balance across 5 zones. A very low N\\* indicates **Narayama Collapse (PEC)** (< 0.71): too few births to replace the legacy generation. Just above that, **Accelerated Tension** (0.71-0.90) already signals an early warning of collapse. The ideal sits in the middle of the scale, a range called **Self-Sustaining Equilibrium Point (PEA)** (0.90-1.40). Just above that, **Population Tension** (1.40-2.00) already signals an early warning of saturation. A very high N\\* indicates **Population Excess Saturation (PEEC)** (≥ 2.00): population growth accelerating beyond institutional absorption capacity. The institutional beacon (+/n/-) doesn't appear here yet: it depends on National Transfer Accounts (NTA) data this project doesn't have yet — see [ainu.systems](https://ainu.systems) for the full methodology.",
        "es": "**Cómo leer el N\\*:** no es una nota de \"cuanto más alto, mejor\" — es un equilibrio a lo largo de 5 zonas. Un N\\* muy bajo indica **Colapso de Narayama (PEC)** (< 0,71): pocos nacimientos no reponen a la generación legataria. Justo por encima, **Tensión Acelerada** (0,71–0,90) ya señala un riesgo temprano de colapso. Lo ideal está en el medio de la escala, franja llamada **Punto de Equilibrio Autosostenible (PEA)** (0,90–1,40). Justo por encima de eso, **Tensión Poblacional** (1,40–2,00) ya señala un riesgo temprano de saturación. Un N\\* muy alto indica **Saturación por Exceso de Contingente (PEEC)** (≥ 2,00): crecimiento poblacional acelerado más allá de la capacidad de absorción institucional. El farol institucional (+/n/-) todavía no aparece aquí: depende de datos de Cuentas de Transferencias Nacionales (NTA) que este proyecto aún no tiene — ver [ainu.systems](https://ainu.systems) para el detalle completo de la metodología.",
        "ja": "**N\\*の読み方：** 「高いほど良い」という指標ではなく、5つのゾーンにわたるバランスを示します。N\\*が非常に低い場合は **ナラヤマ崩壊(PEC)** (0.71未満)を示します：出生数が少なすぎて先代世代を置き換えられません。そのすぐ上の **加速的緊張** (0.71-0.90)は、崩壊の早期警戒シグナルです。理想は尺度の中央、**自己持続的均衡点(PEA)** (0.90-1.40)と呼ばれる範囲にあります。そのすぐ上の **人口的緊張** (1.40-2.00)は、飽和の早期警戒シグナルです。N\\*が非常に高い場合は **人口過剰飽和(PEEC)** (2.00以上)を示します：人口増加が制度的な受容能力を超えて加速しています。制度的ビーコン（+/n/-）はまだここには表示されません：本プロジェクトがまだ保有していないNational Transfer Accounts（NTA）のデータに依存するためです — 詳しい方法論は[ainu.systems](https://ainu.systems)をご覧ください。",
        "ko": "**N\\* 읽는 법:** \"높을수록 좋다\"는 점수가 아니라 5개 구역에 걸친 균형을 나타냅니다. N\\*가 매우 낮으면 **나라야마 붕괴(PEC)** (0.71 미만)를 의미합니다: 출생아 수가 너무 적어 이전 세대를 대체하지 못합니다. 바로 위의 **가속 긴장** (0.71-0.90)은 이미 붕괴의 조기 경고 신호입니다. 이상적인 값은 척도의 중간, **자립 균형점(PEA)** (0.90-1.40)이라 불리는 구간에 있습니다. 바로 위의 **인구 긴장** (1.40-2.00)은 이미 포화의 조기 경고 신호입니다. N\\*가 매우 높으면 **과잉 인구 포화(PEEC)** (2.00 이상)를 의미합니다: 인구 증가가 제도적 수용 능력을 넘어 가속화됩니다. 제도적 신호등(+/n/-)은 아직 여기에 표시되지 않습니다: 이 프로젝트가 아직 보유하지 않은 국민이전계정(NTA) 데이터에 의존하기 때문입니다 — 전체 방법론은 [ainu.systems](https://ainu.systems)를 참고하세요.",
        "it": "**Come leggere l'N\\*:** non è un punteggio \"più alto è meglio\" — è un equilibrio lungo 5 zone. Un N\\* molto basso indica **Collasso di Narayama (PEC)** (< 0,71): poche nascite non sostituiscono la generazione legataria. Subito sopra, **Tensione Accelerata** (0,71–0,90) segnala già un rischio precoce di collasso. L'ideale sta nel mezzo della scala, fascia chiamata **Punto di Equilibrio Autosostenibile (PEA)** (0,90–1,40). Subito sopra questa, **Tensione Demografica** (1,40–2,00) segnala già un rischio precoce di saturazione. Un N\\* molto alto indica **Saturazione per Eccesso Demografico (PEEC)** (≥ 2,00): crescita demografica accelerata oltre la capacità di assorbimento istituzionale. Il faro istituzionale (+/n/-) non appare ancora qui: dipende dai dati dei National Transfer Accounts (NTA) che questo progetto non ha ancora — vedi [ainu.systems](https://ainu.systems) per il dettaglio completo della metodologia.",
        "fi": "**Miten N\\*:ää luetaan:** kyse ei ole \"mitä korkeampi, sitä parempi\" -pisteestä — vaan tasapainosta 5 vyöhykkeen välillä. Hyvin matala N\\* tarkoittaa **Narayama-romahdusta (PEC)** (< 0,71): liian vähän syntyvyyttä korvaamaan edellinen sukupolvi. Heti sen yläpuolella **kiihtyvä jännite** (0,71–0,90) merkitsee jo varhaista romahdusriskiä. Ihanne on asteikon keskellä, alueella nimeltä **itseään ylläpitävä tasapainopiste (PEA)** (0,90–1,40). Heti sen yläpuolella **väestöjännite** (1,40–2,00) merkitsee jo varhaista kyllästymisriskiä. Hyvin korkea N\\* tarkoittaa **väestöylijäämän kyllästymää (PEEC)** (≥ 2,00): väestönkasvu kiihtyy yli institutionaalisen vastaanottokyvyn. Institutionaalinen valo (+/n/-) ei näy vielä tässä: se riippuu National Transfer Accounts (NTA) -tiedoista, joita tällä projektilla ei vielä ole — katso [ainu.systems](https://ainu.systems) koko menetelmä.",
        "fr": "**Comment lire le N\\* :** ce n'est pas une note \"plus c'est haut, mieux c'est\" — c'est un équilibre sur 5 zones. Un N\\* très bas indique un **Effondrement de Narayama (PEC)** (< 0,71) : trop peu de naissances pour remplacer la génération léguée. Juste au-dessus, la **Tension accélérée** (0,71–0,90) signale déjà un risque précoce d'effondrement. L'idéal se situe au milieu de l'échelle, une plage appelée **Point d'équilibre autosuffisant (PEA)** (0,90–1,40). Juste au-dessus, la **Tension démographique** (1,40–2,00) signale déjà un risque précoce de saturation. Un N\\* très élevé indique une **Saturation par excès démographique (PEEC)** (≥ 2,00) : croissance démographique accélérée au-delà de la capacité d'absorption institutionnelle. Le repère institutionnel (+/n/-) n'apparaît pas encore ici : il dépend des données des National Transfer Accounts (NTA), que ce projet n'a pas encore — voir [ainu.systems](https://ainu.systems) pour le détail complet de la méthodologie.",
        "zh": "**如何解读N\\*：** 这不是“越高越好”的分数，而是跨越5个区域的一种平衡。N\\*过低表示 **楢山崩溃(PEC)** (低于0.71)：出生人数过少，无法替代上一代人。紧邻其上的 **加速紧张** (0.71-0.90)已经是崩溃的早期预警信号。理想值位于量表中段，称为 **自我可持续均衡点(PEA)** (0.90-1.40)区间。紧邻其上的 **人口紧张** (1.40-2.00)已经是饱和的早期预警信号。N\\*过高表示 **人口过剩饱和(PEEC)** (2.00及以上)：人口增长速度超过了制度吸纳能力。制度信号灯（+/n/-）此处尚未显示：它依赖于本项目尚未获取的国民转移账户（NTA）数据 — 完整方法论请见[ainu.systems](https://ainu.systems)。",
    },
    "n_star_explicacao_curta": {
        "pt": "O N\\* posiciona os países entre dois extremos de desequilíbrio geracional: insuficiência de renovação e excesso de contingente. A faixa central representa equilíbrio sustentável.",
        "en": "N\\* positions countries between two extremes of generational imbalance: insufficient renewal and excess contingent. The central band represents sustainable equilibrium.",
        "es": "El N\\* posiciona a los países entre dos extremos de desequilibrio generacional: insuficiencia de renovación y exceso de contingente. La franja central representa equilibrio sostenible.",
        "ja": "N\\*は、世代的不均衡の2つの極端——更新不足と過剰な人口——の間に各国を位置づけます。中央帯は持続可能な均衡を表します。",
        "ko": "N\\*는 세대적 불균형의 두 극단—재생산 부족과 과잉 인구—사이에 각국을 위치시킵니다. 중앙 구간은 지속가능한 균형을 나타냅니다.",
        "it": "L'N\\* posiziona i paesi tra due estremi di squilibrio generazionale: insufficiente rinnovamento ed eccesso di contingente. La fascia centrale rappresenta l'equilibrio sostenibile.",
        "fi": "N\\* sijoittaa maat kahden sukupolvien välisen epätasapainon ääripään väliin: riittämätön uusiutuminen ja liiallinen väestömäärä. Keskikaista edustaa kestävää tasapainoa.",
        "fr": "Le N\\* positionne les pays entre deux extrêmes de déséquilibre générationnel : renouvellement insuffisant et excès de contingent. La bande centrale représente l'équilibre durable.",
        "zh": "N\\*将各国定位在世代失衡的两个极端之间：更新不足与人口过剩。中间地带代表可持续平衡。",
    },
    "como_ler_nstar_expander_label": {
        "pt": "Como ler o N\\* — detalhamento por zona", "en": "How to read N\\* — zone-by-zone detail",
        "es": "Cómo leer el N\\* — detalle por zona", "ja": "N\\*の読み方 — ゾーン別詳細",
        "ko": "N\\* 읽는 법 — 구역별 상세", "it": "Come leggere l'N\\* — dettaglio per zona",
        "fi": "Miten N\\*:ää luetaan — vyöhykekohtainen erittely", "fr": "Comment lire le N\\* — détail par zone",
        "zh": "如何解读N\\* — 各区域详情",
    },
    "como_calculamos_expander_label": {
        "pt": "Como as projeções são calculadas", "en": "How the projections are calculated",
        "es": "Cómo se calculan las proyecciones", "ja": "予測の計算方法",
        "ko": "예측 계산 방법", "it": "Come vengono calcolate le proiezioni",
        "fi": "Miten ennusteet lasketaan", "fr": "Comment les projections sont calculées",
        "zh": "预测如何计算",
    },
    "projecoes_resumo_curto": {
        "pt": "As projeções comparam três valores: população atual, população em 2074 pela tendência da ONU e população em 2074 no cenário proposto de convergência da fecundidade. Não constituem previsão.",
        "en": "The projections compare three values: current population, 2074 population under the UN's trend, and 2074 population under the proposed fertility-convergence scenario. They are not a forecast.",
        "es": "Las proyecciones comparan tres valores: población actual, población en 2074 según la tendencia de la ONU y población en 2074 en el escenario propuesto de convergencia de la fecundidad. No constituyen una previsión.",
        "ja": "予測は3つの値を比較します：現在の人口、国連の傾向に基づく2074年の人口、そして提案された出生力収束シナリオに基づく2074年の人口。これは予測ではありません。",
        "ko": "예측은 세 가지 값을 비교합니다: 현재 인구, 유엔 추세에 따른 2074년 인구, 그리고 제안된 출산력 수렴 시나리오에 따른 2074년 인구. 이는 예측이 아닙니다.",
        "it": "Le proiezioni confrontano tre valori: popolazione attuale, popolazione nel 2074 secondo la tendenza dell'ONU e popolazione nel 2074 nello scenario proposto di convergenza della fecondità. Non costituiscono una previsione.",
        "fi": "Ennusteet vertaavat kolmea arvoa: nykyistä väestöä, vuoden 2074 väestöä YK:n trendin mukaan ja vuoden 2074 väestöä ehdotetussa hedelmällisyyden lähentymisskenaariossa. Ne eivät ole ennuste.",
        "fr": "Les projections comparent trois valeurs : population actuelle, population en 2074 selon la tendance de l'ONU, et population en 2074 dans le scénario proposé de convergence de la fécondité. Elles ne constituent pas une prévision.",
        "zh": "预测比较三个数值：当前人口、按联合国趋势计算的2074年人口，以及在拟议生育率收敛情景下的2074年人口。这些并非预测。",
    },
    "atual_label": {
        "pt": "Atual", "en": "Current", "es": "Actual", "ja": "現在",
        "ko": "현재", "it": "Attuale", "fi": "Nykyinen", "fr": "Actuelle", "zh": "当前",
    },
    "tendencia_label_curto": {
        "pt": "tendência", "en": "trend", "es": "tendencia", "ja": "傾向",
        "ko": "추세", "it": "tendenza", "fi": "trendi", "fr": "tendance", "zh": "趋势",
    },
    "cenario_label_curto": {
        "pt": "cenário", "en": "scenario", "es": "escenario", "ja": "シナリオ",
        "ko": "시나리오", "it": "scenario", "fi": "skenaario", "fr": "scénario", "zh": "情景",
    },
    "exemplo_pedagogico_tag": {
        "pt": "exemplo", "en": "example", "es": "ejemplo", "ja": "例",
        "ko": "예시", "it": "esempio", "fi": "esimerkki", "fr": "exemple", "zh": "示例",
    },
    ...
    "narayama_caption_grade": {
        "pt": "Grade dos 8 países destaque por zona do Índice Narayama (Saturação/PEEC → Colapso/PEC), países ordenados por população atual dentro de cada zona. Farol institucional aparece como lacuna (`s/d`) — mesma explicação do quadro acima.",
        "en": "Grid of the 8 featured countries by Narayama Index zone (Population Excess/PEEC → Collapse/PEC), countries ordered by current population within each zone. The institutional beacon shows as a gap (`n/a`) — same explanation as the box above.",
        "es": "Cuadrícula de los 8 países destacados por zona del Índice Narayama (Saturación/PEEC → Colapso/PEC), países ordenados por población actual dentro de cada zona. El farol institucional aparece como laguna (`s/d`) — misma explicación del cuadro de arriba.",
        "ja": "ナラヤマ指数のゾーン別（人口過剰/PEEC → 崩壊/PEC）に注目8か国を並べたグリッドで、各ゾーン内は現在の人口順です。制度的ビーコンは欠落（N/A）として表示されます — 上記ボックスと同じ説明です。",
        "ko": "나라야마 지수 구역별(과잉 인구/PEEC → 붕괴/PEC)로 정리한 주요 8개국 그리드이며, 각 구역 내에서는 현재 인구순으로 정렬됩니다. 제도적 신호등은 공백(N/A)으로 표시됩니다 — 위 상자와 동일한 설명입니다.",
        "it": "Griglia dei 8 paesi in evidenza per zona dell'Indice Narayama (Saturazione/PEEC → Collasso/PEC), paesi ordinati per popolazione attuale all'interno di ogni zona. Il faro istituzionale appare come lacuna (`n/d`) — stessa spiegazione del riquadro sopra.",
        "fi": "7 esitellyn maan ruudukko Narayama-indeksin vyöhykkeen mukaan (väestöylijäämä/PEEC → romahdus/PEC), maat järjestetty nykyisen väestön mukaan kussakin vyöhykkeessä. Institutionaalinen valo näkyy aukkona (N/A) — sama selitys kuin yllä olevassa laatikossa.",
        "fr": "Grille des 8 pays en vedette par zone de l'indice de Narayama (Excès démographique/PEEC → Effondrement/PEC), pays classés par population actuelle au sein de chaque zone. Le repère institutionnel apparaît comme une lacune (`n/d`) — même explication que l'encadré ci-dessus.",
        "zh": "按楢山指数区域（人口过剩/PEEC → 崩溃/PEC）排列的8个重点国家网格，各区域内按当前人口排序。制度信号灯显示为空缺（N/A）——说明同上方信息框。",
    },
    "farol_provisorio_caption": {
        "pt": "Nos 8 países também destacados no narayama.live, existe um valor de farol provisório herdado do modelo demográfico-TFR anterior à atualização do pipeline (Tabela 3.1.1 da tese independente) — mas a decisão foi não publicá-lo: não vem de fonte real de National Transfer Accounts (NTA). Por isso o farol aparece sempre como `s/d` nos cards, mesmo para esses 8 países.",
        "en": "For the 8 countries also featured on narayama.live, a provisional beacon value exists, inherited from the demographic-TFR model that predates the pipeline update (independent-thesis Table 3.1.1) — but the decision was not to publish it: it doesn't come from a real National Transfer Accounts (NTA) source. That's why the beacon always shows as `n/a` on the cards, even for these 8 countries.",
        "es": "Para los 8 países también destacados en narayama.live, existe un valor de farol provisional heredado del modelo demográfico-TFR anterior a la actualización del pipeline (Tabla 3.1.1 de la tesis independiente) — pero la decisión fue no publicarlo: no proviene de una fuente real de Cuentas de Transferencias Nacionales (NTA). Por eso el farol aparece siempre como `s/d` en las tarjetas, incluso para esos 8 países.",
        "ja": "narayama.liveでも注目されている8か国については、パイプライン更新前の人口統計-TFRモデルから引き継いだ暫定的なビーコン値が存在します（独立論文の表3.1.1）— しかし、それを公開しないという決定がなされました：実際のNational Transfer Accounts（NTA）のデータ源に基づくものではないためです。そのため、この8か国についても、カードのビーコンは常にN/Aと表示されます。",
        "ko": "narayama.live에서도 강조되는 8개국에 대해서는, 파이프라인 업데이트 이전의 인구통계-TFR 모델에서 물려받은 잠정적인 신호등 값이 존재합니다(독립 논문 표 3.1.1) — 하지만 이를 공개하지 않기로 결정했습니다: 실제 국민이전계정(NTA) 출처에서 나온 것이 아니기 때문입니다. 그래서 이 8개국에 대해서도 카드의 신호등은 항상 N/A로 표시됩니다.",
        "it": "Per i 8 paesi anche in evidenza su narayama.live, esiste un valore di faro provvisorio ereditato dal modello demografico-TFR precedente all'aggiornamento della pipeline (Tabella 3.1.1 della tesi indipendente) — ma la decisione è stata di non pubblicarlo: non proviene da una fonte reale di National Transfer Accounts (NTA). Per questo il faro appare sempre come `n/d` nelle card, anche per questi 8 paesi.",
        "fi": "Myös narayama.liven 8 esitellylle maalle on olemassa väliaikainen valoarvo, joka on peritty putken päivitystä edeltävästä väestötieteellis-TFR-mallista (tutkimuksen taulukko 3.1.1) — mutta päätös oli olla julkaisematta sitä: se ei perustu todelliseen National Transfer Accounts (NTA) -lähteeseen. Siksi valo näkyy korteissa aina merkinnällä N/A, myös näiden 8 maan kohdalla.",
        "fr": "Pour les 8 pays également mis en avant sur narayama.live, il existe une valeur de repère provisoire héritée du modèle démographique-TFR antérieur à la mise à jour du pipeline (Tableau 3.1.1 de la thèse indépendante) — mais la décision a été de ne pas la publier : elle ne provient pas d'une source réelle de National Transfer Accounts (NTA). C'est pourquoi le repère apparaît toujours comme `n/d` sur les cartes, même pour ces 8 pays.",
        "zh": "在narayama.live同样重点展示的8个国家中，存在一个继承自流水线更新之前人口统计-TFR模型的临时信号灯数值（独立论文表3.1.1）——但决定是不公开它：因为它并非来自真实的国民转移账户（NTA）来源。因此，即使是这8个国家，卡片上的信号灯也始终显示为N/A。",
    },
    ...
    "ainu_intro": {
        "pt": "Cálculos detalhados do Índice de Narayama Sistêmico (N\\*) para os 28 países da amostra, com base em pesquisa independente \"Do Dilema de Narayama ao Oicoceno Civilizacional\" (V12). Para a visão pública e simplificada, veja [narayama.live](https://narayama.live).",
        "en": "Detailed calculations of the Systemic Narayama Index (N\\*) for the 28 countries in the sample, based on independent research \"From Narayama's Dilemma to the Civilizational Oikocene\" (V12). For the public, simplified view, see [narayama.live](https://narayama.live).",
        "es": "Cálculos detallados del Índice de Narayama Sistémico (N\\*) para los 28 países de la muestra, según la investigación independiente \"Del Dilema de Narayama al Oicoceno Civilizacional\" (V12). Para la vista pública y simplificada, vea [narayama.live](https://narayama.live).",
        "ja": "独立研究『ナラヤマのジレンマから文明的オイコセーンへ』（V12）に基づく、サンプル28か国のシステミック・ナラヤマ指数（N\\*）の詳細な計算です。公開・簡易版は[narayama.live](https://narayama.live)をご覧ください。",
        "ko": "독립 연구 『나라야마의 딜레마에서 문명적 오이코세까지』(V12)를 바탕으로 한 표본 28개국의 체계적 나라야마 지수(N\\*) 상세 계산입니다. 공개용 간략 버전은 [narayama.live](https://narayama.live)를 참고하세요.",
        "it": "Calcoli dettagliati dell'Indice di Narayama Sistemico (N\\*) per i 28 paesi del campione, sulla base di una ricerca indipendente \"Dal Dilemma di Narayama all'Oicocene Civilizzazionale\" (V12). Per la vista pubblica e semplificata, vedi [narayama.live](https://narayama.live).",
        "fi": "Yksityiskohtaiset laskelmat systeemisestä Narayama-indeksistä (N\\*) otoksen 28 maalle, perustuen itsenäiseen tutkimukseen \"Narayaman dilemmasta sivilisaation Oikoseeniin\" (V12). Julkista, yksinkertaistettua näkymää varten katso [narayama.live](https://narayama.live).",
        "fr": "Calculs détaillés de l'indice de Narayama systémique (N\\*) pour les 28 pays de l'échantillon, d'après une recherche indépendante \"Du Dilemme de Narayama à l'Oïcocène Civilisationnel\" (V12). Pour la vue publique simplifiée, voir [narayama.live](https://narayama.live).",
        "zh": "基于独立研究《从楢山难题到文明世的宜居纪》(V12)，对样本中28个国家的系统性楢山指数（N\\*）进行详细计算。公开简化版请见[narayama.live](https://narayama.live)。",
    },
    ...
    "tabela_geracional_caption_ainu": {
        "pt": "Grade comparativa dos 28 países segundo o N\\* (Seção 9-A.7 da tese independente, revisão de 12/07/2026). Eixo horizontal = zona do Índice Narayama (Saturação/PEEC → Colapso/PEC); eixo vertical, dentro de cada zona = população atual, maior no topo. Mostra sempre os 28 países, independente dos filtros de Perfil/Região acima.",
        "en": "Comparative grid of the 28 countries by N\\* (independent-thesis Section 9-A.7, 2026-07-12 revision). Horizontal axis = Narayama Index zone (Population Excess/PEEC → Collapse/PEC); vertical axis, within each zone = current population, largest at the top. Always shows all 28 countries, regardless of the Profile/Region filters above.",
        "es": "Cuadrícula comparativa de los 28 países según el N\\* (Sección 9-A.7 de la tesis independiente, revisión del 12/07/2026). Eje horizontal = zona del Índice Narayama (Saturación/PEEC → Colapso/PEC); eje vertical, dentro de cada zona = población actual, mayor arriba. Muestra siempre los 28 países, independientemente de los filtros de Perfil/Región de arriba.",
        "ja": "N\\*による28か国の比較グリッド（独立論文セクション9-A.7、2026年7月12日改訂）。横軸＝ナラヤマ指数のゾーン（人口過剰/PEEC → 崩壊/PEC）、各ゾーン内の縦軸＝現在の人口（上ほど多い）。上部のプロファイル/地域フィルターにかかわらず、常に28か国すべてを表示します。",
        "ko": "N\\*에 따른 28개국 비교 그리드(독립 논문 9-A.7절, 2026-07-12 개정). 가로축 = 나라야마 지수 구역(과잉 인구/PEEC → 붕괴/PEC); 각 구역 내 세로축 = 현재 인구(위로 갈수록 많음). 위의 프로필/지역 필터와 무관하게 항상 28개국 전체를 표시합니다.",
        "it": "Griglia comparativa dei 28 paesi secondo l'N\\* (Sezione 9-A.7 della tesi indipendente, revisione del 12/07/2026). Asse orizzontale = zona dell'Indice Narayama (Saturazione/PEEC → Collasso/PEC); asse verticale, all'interno di ogni zona = popolazione attuale, maggiore in alto. Mostra sempre i 28 paesi, indipendentemente dai filtri di Profilo/Regione sopra.",
        "fi": "28 maan vertailuruudukko N\\*:n mukaan (tutkimuksen osa 9-A.7, tarkistettu 12.7.2026). Vaaka-akseli = Narayama-indeksin vyöhyke (väestöylijäämä/PEEC → romahdus/PEC); pystyakseli kussakin vyöhykkeessä = nykyinen väestö, suurin ylhäällä. Näyttää aina kaikki 28 maata riippumatta yllä olevista profiili-/aluesuodattimista.",
        "fr": "Grille comparative des 28 pays selon le N\\* (Section 9-A.7 de la thèse indépendante, révision du 12/07/2026). Axe horizontal = zone de l'indice de Narayama (Excès démographique/PEEC → Effondrement/PEC) ; axe vertical, au sein de chaque zone = population actuelle, la plus grande en haut. Affiche toujours les 28 pays, indépendamment des filtres Profil/Région ci-dessus.",
        "zh": "按N\\*划分的28个国家比较网格（独立论文第9-A.7节，2026年7月12日修订）。横轴=楢山指数区域（人口过剩/PEEC → 崩溃/PEC）；纵轴（各区域内）=当前人口，越靠上人口越多。无论上方的类型/地区筛选如何，始终显示全部28个国家。",
    },
    "farol_gap_caption": {
    ...
    "glossario_intro": {
        "pt": "Todos os termos e siglas da tese independente, em ordem de aparição — inclui conceitos de fases futuras ainda não implementadas neste projeto (Anexo 14 da tese independente V12, com a correção dos limiares de PEC/PEA/PEEC pra convenção adotada de 5 zonas, ver docs/definitions.md).",
        "en": "All terms and acronyms from the independent thesis, in order of appearance — includes concepts from future phases not yet implemented in this project (independent thesis V12, Annex 14, with PEC/PEA/PEEC thresholds corrected to the adopted 5-zone convention — see docs/definitions.md).",
        "es": "Todos los términos y siglas de la tesis independiente, en orden de aparición — incluye conceptos de fases futuras aún no implementadas en este proyecto (Anexo 14 de la tesis independiente V12, con la corrección de los umbrales de PEC/PEA/PEEC a la convención adoptada de 5 zonas, ver docs/definitions.md).",
        "ja": "独立論文のすべての用語と略語を、登場順に記載 — 本プロジェクトではまだ実装されていない将来フェーズの概念も含む（独立論文V12、附属書14、PEC/PEA/PEECの閾値は採用された5ゾーン規約に修正済み — docs/definitions.md参照）。",
        "ko": "독립 논문의 모든 용어와 약어를 등장 순서대로 수록 — 이 프로젝트에서 아직 구현되지 않은 향후 단계의 개념도 포함(독립 논문 V12, 부록 14, PEC/PEA/PEEC 임계값은 채택된 5구역 규약으로 수정됨 — docs/definitions.md 참고).",
        "it": "Tutti i termini e le sigle della tesi indipendente, in ordine di apparizione — include concetti di fasi future non ancora implementate in questo progetto (Allegato 14 della tesi indipendente V12, con la correzione delle soglie PEC/PEA/PEEC alla convenzione adottata a 5 zone, vedi docs/definitions.md).",
        "fi": "Kaikki tutkimuksen termit ja lyhenteet esiintymisjärjestyksessä — sisältää käsitteitä tulevista vaiheista, joita ei ole vielä toteutettu tässä projektissa (tutkimus V12, liite 14, PEC/PEA/PEEC-kynnysarvot korjattu vastaamaan hyväksyttyä 5-vyöhykkeen käytäntöä — katso docs/definitions.md).",
        "fr": "Tous les termes et acronymes de la thèse indépendante, dans l'ordre d'apparition — inclut des concepts de phases futures pas encore implémentées dans ce projet (Annexe 14 de la thèse indépendante V12, avec les seuils PEC/PEA/PEEC corrigés selon la convention adoptée à 5 zones, voir docs/definitions.md).",
        "zh": "独立论文中所有术语和缩写，按出现顺序排列——包括本项目尚未实现的未来阶段概念（独立论文V12附录14，其中PEC/PEA/PEEC阈值已按采用的5区域惯例更正——见docs/definitions.md）。",
    },
    "footer_ainu": {
...
# -----------------------------------------------------------------------
# Glossário (Anexo 14 da tese V12) — termos e siglas de todo o projeto,
...
GLOSSARIO: list[dict] = [
    {
        ...
        "pt": "Sistema computacional que calcula o N\\* e demais índices pra os 28 países da amostra. narayama.live é a interface pública (8 países destaque); ainu.systems, a interface restrita a pesquisadores.",
        "en": "The computational system that calculates N\\* and the other indices for the 28 countries in the sample. narayama.live is the public interface (8 featured countries); ainu.systems is the interface restricted to researchers.",
        "es": "Sistema computacional que calcula el N\\* y los demás índices para los 28 países de la muestra. narayama.live es la interfaz pública (8 países destacados); ainu.systems, la interfaz restringida a investigadores.",
        "ja": "サンプル28か国のN\\*および他の指標を計算する計算システム。narayama.liveは公開インターフェース（注目8か国）、ainu.systemsは研究者限定インターフェース。",
        "ko": "표본 28개국의 N\\* 및 기타 지수를 계산하는 전산 시스템. narayama.live는 공개 인터페이스(주요 8개국), ainu.systems는 연구자 전용 인터페이스.",
        "it": "Sistema computazionale che calcola l'N\\* e gli altri indici per i 28 paesi del campione. narayama.live è l'interfaccia pubblica (8 paesi in evidenza); ainu.systems è l'interfaccia riservata ai ricercatori.",
        "fi": "Laskentajärjestelmä, joka laskee N\\*:n ja muut indeksit otoksen 28 maalle. narayama.live on julkinen käyttöliittymä (8 esiteltyä maata); ainu.systems on tutkijoille rajattu käyttöliittymä.",
        "fr": "Système informatique qui calcule le N\\* et les autres indices pour les 28 pays de l'échantillon. narayama.live est l'interface publique (8 pays en vedette) ; ainu.systems, l'interface réservée aux chercheurs.",
        "zh": "为样本中28个国家计算N\\*及其他指数的计算系统。narayama.live是公开界面（8个重点国家）；ainu.systems是仅限研究人员使用的界面。",
    },
    {
    ...
    {
        "termo": None, "nome_zona": "Ponto de Equilíbrio Autossustentável (PEA)", "resumido": True,
    ...
    {
        "termo": None, "nome_zona": "Saturação por Excesso de Contingente (PEEC)", "resumido": True,
    ...
    },
    {
        ...
        "pt": "Extensão da NTA que inclui tempo não remunerado de cuidado (doméstico, educação parental, cuidado de idosos). Valida o conceito de CHR desta tese independente.",
        "en": "An NTA extension that includes unpaid care time (domestic, parental education, elder care). Validates this independent thesis's CHR concept.",
        "es": "Extensión de la NTA que incluye tiempo no remunerado de cuidado (doméstico, educación parental, cuidado de mayores). Valida el concepto de CHR de esta tesis independiente.",
        "ja": "無償のケア時間（家事、親の教育、高齢者ケア）を含むNTAの拡張。本独立論文のCHR概念を裏付ける。",
        "ko": "무급 돌봄 시간(가사, 부모 교육, 노인 돌봄)을 포함하는 NTA의 확장. 이 독립 논문의 CHR 개념을 뒷받침함.",
        "it": "Estensione della NTA che include il tempo di cura non retribuito (domestico, educazione parentale, cura degli anziani). Convalida il concetto di CHR di questa tesi indipendente.",
        "fi": "NTA:n laajennus, joka sisältää palkattoman hoiva-ajan (kotityö, vanhempainkasvatus, vanhustenhoito). Vahvistaa tämän tutkimuksen CHR-käsitteen.",
        "fr": "Une extension de la NTA incluant le temps de soin non rémunéré (domestique, éducation parentale, soin aux aînés). Valide le concept de CHR de cette thèse indépendante.",
        "zh": "NTA的扩展，纳入无偿照护时间（家务、亲职教育、老年照护）。验证了本独立论文的CHR概念。",
    },
    {
    ...
    },
    {
        ...
        "pt": "Modelo macroeconômico de gerações sobrepostas (Samuelson, Diamond), usado nesta tese independente pra simulações até 2070. Não implementado neste projeto.",
        "en": "The overlapping-generations macroeconomic model (Samuelson, Diamond), used in this independent thesis for simulations to 2070. Not implemented in this project.",
        "es": "Modelo macroeconómico de generaciones superpuestas (Samuelson, Diamond), usado en esta tesis independiente para simulaciones hasta 2070. No implementado en este proyecto.",
        "ja": "重複世代マクロ経済モデル（サミュエルソン、ダイアモンド）、本独立論文では2070年までのシミュレーションに使用。本プロジェクトでは未実装。",
        "ko": "중첩세대 거시경제 모델(Samuelson, Diamond), 이 독립 논문에서는 2070년까지의 시뮬레이션에 사용됨. 이 프로젝트에서는 구현되지 않음.",
        "it": "Modello macroeconomico a generazioni sovrapposte (Samuelson, Diamond), usato in questa tesi indipendente per simulazioni fino al 2070. Non implementato in questo progetto.",
        "fi": "Päällekkäisten sukupolvien makrotaloudellinen malli (Samuelson, Diamond), jota käytetään tässä tutkimuksessa simulaatioihin vuoteen 2070 asti. Ei toteutettu tässä projektissa.",
        "fr": "Le modèle macroéconomique à générations imbriquées (Samuelson, Diamond), utilisé dans cette thèse indépendante pour des simulations jusqu'en 2070. Non implémenté dans ce projet.",
        "zh": "世代交叠宏观经济模型（Samuelson, Diamond），本独立论文用于模拟至2070年的情景。本项目尚未实现。",
    },
    {
